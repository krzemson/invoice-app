...
$invoice = Invoice::findById($_GET['id']);
...
if (isset($_POST['submit'])) {
    ...
    for ($i = 0; $i < count($_POST['service']); $i++) {
        $service = Service::findById($_POST['id'][$i]);
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edytuj fakturę sprzedaży</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        ...
        <div class="row">
            ...
            <?php if (isset($message)) :?>
                <div class="alert alert-success alert-dismissible">
                    ...
                    <?php echo $message; ?> <a href="/admin/invoices"><b>Wróć</b></a>
                </div>
            <?php endif; ?>
